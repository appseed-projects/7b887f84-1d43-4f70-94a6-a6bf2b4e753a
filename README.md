...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-07 20:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7b887f84-1d43-4f70-94a6-a6bf2b4e753a.git
$ cd 7b887f84-1d43-4f70-94a6-a6bf2b4e753a
```
